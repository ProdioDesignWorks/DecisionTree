...
function DecisionTree() {
    ...
    var _config$data = config.data,
        ...
        features = _config$features === undefined ? [] : _config$features,
        _config$fixMissingFea = config.fixMissingFeatures,
        fixMissingFeatures = _config$fixMissingFea === undefined ? false : _config$fixMissingFea,
        _config$persist = config.persist,
        persist = _config$persist === undefined ? false : _config$persist,
        _config$load = config.load,
        load = _config$load === undefined ? false : _config$load,
        _config$learn = config.learn,
        learn = _config$learn === undefined ? false : _config$learn,
